...
fn test_execution_failure_status_variants() {
    let variants: Vec<ExecutionFailureStatus> = vec![
        ...
        ExecutionFailureStatus::ModelWeightsUrlMismatch,
        ...
        ExecutionFailureStatus::ChallengeWindowOpen { fill_epoch: 1, current_epoch: 2 },
        ...
        ExecutionFailureStatus::ChallengeWindowClosed { fill_epoch: 1, current_epoch: 5 },
        ExecutionFailureStatus::InsufficientChallengerBond { required: 100, provided: 50 },
        ExecutionFailureStatus::ChallengeNotFound { challenge_id: ObjectID::ZERO },
        ExecutionFailureStatus::ChallengeNotPending { challenge_id: ObjectID::ZERO },
        ExecutionFailureStatus::ChallengeAlreadyExists,
        ExecutionFailureStatus::ChallengeExpired { challenge_epoch: 1, current_epoch: 5 },
        ExecutionFailureStatus::InvalidChallengeResult,
        ExecutionFailureStatus::InvalidChallengeQuorum,
