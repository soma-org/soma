...
//! the data, and the embedding/score reported by the miner.
//!
//! Key design decisions:
//! - Single transaction (no commit-reveal) - front-running deferred to future versions
//! - Distance score is submitter-reported and verified during challenge audit
...
/// downloading, the chosen model, and the reported distance score.
///
/// The distance_score is submitter-reported and verified only during challenge
/// audit by re-running inference.
