...
impl BlockManager {
    ...
    pub fn try_accept_blocks(
        ...
        for block in blocks {
            ...
            for (_block_ref, block) in blocks_to_reject {
    ...
    /// blocks.
    pub fn missing_blocks(&self) -> BTreeSet<BlockRef> {
...
mod tests {
    ...
    use crate::dag::{block_manager::BlockManager, dag_state::DagState, test_dag::DagBuilder};
