...
use crate::digests::{CheckpointContentsDigest, CheckpointDigest, TransactionDigest};
...
impl ObjectStore for SharedInMemoryStore {
    fn get_object(&self, _object_id: &crate::object::ObjectID) -> Option<crate::object::Object> {
        todo!()
    }

    fn get_object_by_key(
        &self,
        _object_id: &crate::object::ObjectID,
        _version: crate::object::Version,
