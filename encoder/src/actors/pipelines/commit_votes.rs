...
pub(crate) struct CommitVotesProcessor<E: EncoderInternalNetworkClient> {
    store: Arc<dyn Store>,
    shard_tracker: ShardTracker<E>,
}

impl<E: EncoderInternalNetworkClient> CommitVotesProcessor<E> {
...
#[async_trait]
impl<E: EncoderInternalNetworkClient> Processor for CommitVotesProcessor<E> {
    type Input = (
        Shard,
