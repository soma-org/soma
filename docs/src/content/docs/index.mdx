...
- **Use the network.** Run `soma start proxy` locally, point any OpenAI-compatible client at it, and your requests get routed to the cheapest provider for the model you asked for. Charges are deducted from a payment channel you opened with that provider.
