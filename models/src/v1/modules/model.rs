...
use crate::{
    ...
    v1::{
        V1_BATCH_SIZE, V1_EMBEDDING_DIM, V1_MAX_SEQ_LEN, V1_MAX_WAVELENGTH, V1_NUM_HEADS,
        V1_NUM_LAYERS, V1_PWFF_HIDDEN_DIM, V1_SCALE_FACTOR, V1_SIG_REG_POINTS, V1_SIG_REG_SLICES,
        V1_SIG_REG_T_MAX, V1_VOCAB_SIZE,
...
pub struct ModelConfig {
    ...
    #[config(default = "V1_MAX_SEQ_LEN")]
    pub max_seq_len: usize,
    #[config(default = "V1_BATCH_SIZE")]
...
//     type Backend = B;
//     fn build_data(&self, buffer: Arc<[u8]>) -> Self::Data {
