use crate::{context::Context, AuthorityIndex, NetworkKeyPair};
...
pub(crate) fn create_rustls_server_config(
    ...
    let verifier = ClientCertVerifier::new(allower, certificate_server_name(context));
...
pub(crate) fn create_rustls_client_config(
    ...
    let tls_private_key = self_signed_cert.rustls_private_key();
    let mut tls_config =
        ServerCertVerifier::new(target_public_key, certificate_server_name(context))
