    ...
    fn try_from(proto_params: SystemParameters) -> Result<Self, Self::Error> {
        Ok(protocol_config::SystemParameters {
            ...
            target_max_reconstruction_threshold: proto_params
                ...
                .ok_or(
                "Missing target_max_reconstruction_threshold",
            )?,
            target_min_reconstruction_threshold: proto_params
                .target_min_reconstruction_threshold
                .ok_or(
                "Missing target_min_reconstruction_threshold",
            )?,
    ...
    fn try_from(domain_params: protocol_config::SystemParameters) -> Result<Self, Self::Error> {
        Ok(SystemParameters {
            ...
            target_initial_distance_threshold: Some(
                domain_params.target_initial_distance_threshold,
            ),
            target_initial_reconstruction_threshold: Some(
                domain_params.target_initial_reconstruction_threshold,
            ),
            ...
            target_max_reconstruction_threshold: Some(
                domain_params.target_max_reconstruction_threshold,
            ),
            target_min_reconstruction_threshold: Some(
                domain_params.target_min_reconstruction_threshold,
            ),
