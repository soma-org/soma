...
impl From<crate::types::CommandArgumentError> for CommandArgumentError {
    fn from(value: crate::types::CommandArgumentError) -> Self {
        use crate::types::CommandArgumentError as E;
...
impl TryFrom<&CommandArgumentError> for crate::types::CommandArgumentError {
    type Error = TryFromProtoError;
...
impl From<crate::types::TypeArgumentError> for type_argument_error::TypeArgumentErrorKind {
    fn from(value: crate::types::TypeArgumentError) -> Self {
        use crate::types::TypeArgumentError::*;
...
impl TryFrom<type_argument_error::TypeArgumentErrorKind> for crate::types::TypeArgumentError {
    type Error = TryFromProtoError;
...
impl From<crate::types::PackageUpgradeError> for PackageUpgradeError {
    fn from(value: crate::types::PackageUpgradeError) -> Self {
        use crate::types::PackageUpgradeError as E;
...
impl TryFrom<&PackageUpgradeError> for crate::types::PackageUpgradeError {
    type Error = TryFromProtoError;
...
impl From<crate::types::MoveLocation> for MoveLocation {
    fn from(value: crate::types::MoveLocation) -> Self {
        Self {
...
impl TryFrom<&MoveLocation> for crate::types::MoveLocation {
    type Error = TryFromProtoError;
