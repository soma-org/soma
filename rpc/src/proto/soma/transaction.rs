...
impl From<crate::types::TransactionExpiration> for TransactionExpiration {
    fn from(value: crate::types::TransactionExpiration) -> Self {
...
impl TryFrom<&TransactionExpiration> for crate::types::TransactionExpiration {
    type Error = TryFromProtoError;
...
impl From<crate::types::TransactionKind> for TransactionKind {
    fn from(value: crate::types::TransactionKind) -> Self {
        ...
        let kind = match value {
            ...
            EndOfEpoch(transactions) => Kind::EndOfEpoch(EndOfEpochTransaction {
...
impl TryFrom<&TransactionKind> for crate::types::TransactionKind {
    ...
    fn try_from(value: &TransactionKind) -> Result<Self, Self::Error> {
            ...
            .ok_or_else(|| TryFromProtoError::missing("kind"))?
        {
            ...
            Kind::ProgrammableSystemTransaction(ptb) => {
                Self::ProgrammableSystemTransaction(ptb.try_into()?)
            }
...
impl From<crate::types::ConsensusCommitPrologueV2> for ConsensusCommitPrologue {
    fn from(value: crate::types::ConsensusCommitPrologueV2) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp: Some(crate::proto::timestamp_ms_to_proto(
...
impl TryFrom<&ConsensusCommitPrologue> for crate::types::ConsensusCommitPrologueV2 {
    type Error = TryFromProtoError;
...
impl From<crate::types::ConsensusCommitPrologueV3> for ConsensusCommitPrologue {
    fn from(value: crate::types::ConsensusCommitPrologueV3) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
            commit_timestamp: Some(crate::proto::timestamp_ms_to_proto(
...
impl TryFrom<&ConsensusCommitPrologue> for crate::types::ConsensusCommitPrologueV3 {
    type Error = TryFromProtoError;
...
impl From<crate::types::ConsensusCommitPrologueV4> for ConsensusCommitPrologue {
    fn from(
        crate::types::ConsensusCommitPrologueV4 {
            epoch,
            round,
            sub_dag_index,
            commit_timestamp_ms,
...
impl TryFrom<&ConsensusCommitPrologue> for crate::types::ConsensusCommitPrologueV4 {
    type Error = TryFromProtoError;
...
impl From<crate::types::ConsensusDeterminedVersionAssignments>
    for ConsensusDeterminedVersionAssignments
{
    fn from(value: crate::types::ConsensusDeterminedVersionAssignments) -> Self {
        use crate::types::ConsensusDeterminedVersionAssignments::*;
...
impl TryFrom<&ConsensusDeterminedVersionAssignments>
    for crate::types::ConsensusDeterminedVersionAssignments
{
    type Error = TryFromProtoError;
...
impl From<crate::types::CanceledTransaction> for CanceledTransaction {
    fn from(value: crate::types::CanceledTransaction) -> Self {
        Self {
...
impl TryFrom<&CanceledTransaction> for crate::types::CanceledTransaction {
    type Error = TryFromProtoError;
...
impl From<crate::types::CanceledTransactionV2> for CanceledTransaction {
    fn from(value: crate::types::CanceledTransactionV2) -> Self {
        Self {
            digest: Some(value.digest.to_string()),
            version_assignments: value
                .version_assignments
...
impl TryFrom<&CanceledTransaction> for crate::types::CanceledTransactionV2 {
    type Error = TryFromProtoError;
...
impl From<crate::types::VersionAssignment> for VersionAssignment {
    fn from(value: crate::types::VersionAssignment) -> Self {
        Self {
...
impl TryFrom<&VersionAssignment> for crate::types::VersionAssignment {
    type Error = TryFromProtoError;
...
impl From<crate::types::VersionAssignmentV2> for VersionAssignment {
    fn from(value: crate::types::VersionAssignmentV2) -> Self {
        Self {
            object_id: Some(value.object_id.to_string()),
...
impl TryFrom<&VersionAssignment> for crate::types::VersionAssignmentV2 {
    type Error = TryFromProtoError;
...
impl From<crate::types::RandomnessStateUpdate> for RandomnessStateUpdate {
    fn from(value: crate::types::RandomnessStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
...
impl TryFrom<&RandomnessStateUpdate> for crate::types::RandomnessStateUpdate {
    type Error = TryFromProtoError;
...
impl From<crate::types::AuthenticatorStateUpdate> for AuthenticatorStateUpdate {
    fn from(value: crate::types::AuthenticatorStateUpdate) -> Self {
        Self {
            epoch: Some(value.epoch),
            round: Some(value.round),
...
impl TryFrom<&AuthenticatorStateUpdate> for crate::types::AuthenticatorStateUpdate {
    type Error = TryFromProtoError;
...
impl From<crate::types::Jwk> for Jwk {
    fn from(crate::types::Jwk { kty, e, n, alg }: crate::types::Jwk) -> Self {
        Self {
            kty: Some(kty),
            e: Some(e),
            n: Some(n),
...
impl TryFrom<&Jwk> for crate::types::Jwk {
    type Error = TryFromProtoError;
...
impl From<crate::types::JwkId> for JwkId {
    fn from(crate::types::JwkId { iss, kid }: crate::types::JwkId) -> Self {
        Self {
            iss: Some(iss),
            kid: Some(kid),
        }
...
impl TryFrom<&JwkId> for crate::types::JwkId {
    type Error = TryFromProtoError;
...
impl From<crate::types::ActiveJwk> for ActiveJwk {
    fn from(value: crate::types::ActiveJwk) -> Self {
        Self {
...
impl TryFrom<&ActiveJwk> for crate::types::ActiveJwk {
    type Error = TryFromProtoError;
...
impl From<crate::types::SystemPackage> for SystemPackage {
    fn from(value: crate::types::SystemPackage) -> Self {
        Self {
            version: Some(value.version),
...
impl TryFrom<&SystemPackage> for crate::types::SystemPackage {
    type Error = TryFromProtoError;
...
impl From<crate::types::EndOfEpochTransactionKind> for EndOfEpochTransactionKind {
    fn from(value: crate::types::EndOfEpochTransactionKind) -> Self {
        use crate::types::EndOfEpochTransactionKind::*;
...
impl TryFrom<&EndOfEpochTransactionKind> for crate::types::EndOfEpochTransactionKind {
    type Error = TryFromProtoError;
...
impl From<crate::types::AuthenticatorStateExpire> for AuthenticatorStateExpire {
    fn from(value: crate::types::AuthenticatorStateExpire) -> Self {
        Self {
...
impl TryFrom<&AuthenticatorStateExpire> for crate::types::AuthenticatorStateExpire {
    type Error = TryFromProtoError;
...
impl From<crate::types::ExecutionTimeObservations> for ExecutionTimeObservations {
    fn from(value: crate::types::ExecutionTimeObservations) -> Self {
        match value {
            crate::types::ExecutionTimeObservations::V1(vec) => Self {
                version: Some(1),
...
impl TryFrom<&ExecutionTimeObservations> for crate::types::ExecutionTimeObservations {
    type Error = TryFromProtoError;
...
impl
    From<(
        crate::types::ExecutionTimeObservationKey,
        Vec<crate::types::ValidatorExecutionTimeObservation>,
    )> for ExecutionTimeObservation
{
    fn from(
        ...
        use crate::types::ExecutionTimeObservationKey;
    ...
    )
{
    ...
    fn try_from(value: &ExecutionTimeObservation) -> Result<Self, Self::Error> {
        ...
        let observations = value
            ...
            .iter()
            .map(crate::types::ValidatorExecutionTimeObservation::try_from)
            .collect::<Result<_, _>>()?;
...
impl From<crate::types::ValidatorExecutionTimeObservation> for ValidatorExecutionTimeObservation {
    fn from(value: crate::types::ValidatorExecutionTimeObservation) -> Self {
        Self {
...
impl TryFrom<&ValidatorExecutionTimeObservation>
    for crate::types::ValidatorExecutionTimeObservation
{
    type Error = TryFromProtoError;
...
impl From<crate::types::ProgrammableTransaction> for ProgrammableTransaction {
    fn from(value: crate::types::ProgrammableTransaction) -> Self {
        Self {
...
impl TryFrom<&ProgrammableTransaction> for crate::types::ProgrammableTransaction {
    type Error = TryFromProtoError;
...
impl From<crate::types::Input> for Input {
    fn from(value: crate::types::Input) -> Self {
...
impl TryFrom<&Input> for crate::types::Input {
    type Error = TryFromProtoError;
    ...
    fn try_from(value: &Input) -> Result<Self, Self::Error> {
        ...
        match value.kind() {
            ...
            InputKind::ImmutableOrOwned => {
                ...
                let reference = crate::types::ObjectReference::new(object_id, version, digest);
...
impl From<crate::types::Argument> for Argument {
    fn from(value: crate::types::Argument) -> Self {
...
impl TryFrom<&Argument> for crate::types::Argument {
    type Error = TryFromProtoError;
...
impl From<crate::types::Command> for Command {
    fn from(value: crate::types::Command) -> Self {
...
impl From<crate::types::MoveCall> for MoveCall {
    fn from(value: crate::types::MoveCall) -> Self {
        Self {
...
impl TryFrom<&MoveCall> for crate::types::MoveCall {
    type Error = TryFromProtoError;
...
impl From<crate::types::TransferObjects> for TransferObjects {
    fn from(value: crate::types::TransferObjects) -> Self {
        Self {
            objects: value.objects.into_iter().map(Into::into).collect(),
...
impl TryFrom<&TransferObjects> for crate::types::TransferObjects {
    type Error = TryFromProtoError;
...
impl From<crate::types::SplitCoins> for SplitCoins {
    fn from(value: crate::types::SplitCoins) -> Self {
        Self {
...
impl TryFrom<&SplitCoins> for crate::types::SplitCoins {
    type Error = TryFromProtoError;
...
impl From<crate::types::MergeCoins> for MergeCoins {
    fn from(value: crate::types::MergeCoins) -> Self {
        Self {
            coin: Some(value.coin.into()),
...
impl TryFrom<&MergeCoins> for crate::types::MergeCoins {
    type Error = TryFromProtoError;
...
impl From<crate::types::Publish> for Publish {
    fn from(value: crate::types::Publish) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.iter().map(ToString::to_string).collect(),
        }
...
impl TryFrom<&Publish> for crate::types::Publish {
    type Error = TryFromProtoError;
...
impl From<crate::types::MakeMoveVector> for MakeMoveVector {
    fn from(value: crate::types::MakeMoveVector) -> Self {
        Self {
...
impl TryFrom<&MakeMoveVector> for crate::types::MakeMoveVector {
    type Error = TryFromProtoError;
...
impl From<crate::types::Upgrade> for Upgrade {
    fn from(value: crate::types::Upgrade) -> Self {
        Self {
            modules: value.modules.into_iter().map(Into::into).collect(),
            dependencies: value.dependencies.iter().map(ToString::to_string).collect(),
            package: Some(value.package.to_string()),
...
impl TryFrom<&Upgrade> for crate::types::Upgrade {
    type Error = TryFromProtoError;
