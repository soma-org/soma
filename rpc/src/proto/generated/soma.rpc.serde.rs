...
impl serde::Serialize for ClaimEscrow {
        ...
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.shard_ref.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("soma.rpc.ClaimEscrow", len)?;
        if let Some(v) = self.shard_ref.as_ref() {
            struct_ser.serialize_field("shardRef", v)?;
        }
        struct_ser.end()
    }
}
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "shardRef" | "shard_ref" => Ok(GeneratedField::ShardRef),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ClaimEscrow, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut shard_ref__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::ShardRef => {
                            if shard_ref__.is_some() {
                                return Err(serde::de::Error::duplicate_field("shardRef"));
                            }
                            shard_ref__ = map_.next_value()?;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
                        }
...
impl serde::Serialize for ClaimReward {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.ClaimReward", len)?;
...
impl<'de> serde::Deserialize<'de> for ClaimReward {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "targetRef" | "target_ref" => Ok(GeneratedField::TargetRef),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = ClaimReward;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.ClaimReward")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<ClaimReward, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("soma.rpc.ClaimReward", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for EncoderCommittee {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        if self.shard_size.is_some() {
            len += 1;
        }
        if self.quorum_threshold.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("soma.rpc.EncoderCommittee", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
        ...
        if let Some(v) = self.shard_size.as_ref() {
            struct_ser.serialize_field("shardSize", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for EncoderCommittee {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "shardSize" | "shard_size" => Ok(GeneratedField::ShardSize),
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = EncoderCommittee;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.EncoderCommittee")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EncoderCommittee, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                let mut members__ = None;
                let mut shard_size__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ShardSize => {
                            if shard_size__.is_some() {
                                return Err(serde::de::Error::duplicate_field("shardSize"));
                            }
                            shard_size__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                ...
                Ok(EncoderCommittee {
                    ...
                    shard_size: shard_size__,
                    quorum_threshold: quorum_threshold__,
                })
            }
        }
        deserializer.deserialize_struct("soma.rpc.EncoderCommittee", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for EncoderCommitteeMember {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.EncoderCommitteeMember", len)?;
        if let Some(v) = self.voting_power.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("votingPower", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.encoder_key.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("encoderKey", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.probe.as_ref() {
...
impl<'de> serde::Deserialize<'de> for EncoderCommitteeMember {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            "votingPower" | "voting_power" => Ok(GeneratedField::VotingPower),
                            "encoderKey" | "encoder_key" => Ok(GeneratedField::EncoderKey),
                            "probe" => Ok(GeneratedField::Probe),
                            "internalNetworkAddress" | "internal_network_address" => Ok(GeneratedField::InternalNetworkAddress),
                            "externalNetworkAddress" | "external_network_address" => Ok(GeneratedField::ExternalNetworkAddress),
                            "objectServerAddress" | "object_server_address" => Ok(GeneratedField::ObjectServerAddress),
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = EncoderCommitteeMember;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.EncoderCommitteeMember")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<EncoderCommitteeMember, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut voting_power__ = None;
                let mut encoder_key__ = None;
                let mut probe__ = None;
                let mut internal_network_address__ = None;
                let mut external_network_address__ = None;
                let mut object_server_address__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::EncoderKey => {
                            if encoder_key__.is_some() {
                                return Err(serde::de::Error::duplicate_field("encoderKey"));
                            }
                            encoder_key__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::BytesDeserialize<_>>>()?.map(|x| x.0)
                            ;
                ...
                Ok(EncoderCommitteeMember {
                    voting_power: voting_power__,
                    encoder_key: encoder_key__,
                    probe: probe__,
                    internal_network_address: internal_network_address__,
                    external_network_address: external_network_address__,
                    object_server_address: object_server_address__,
        ...
        deserializer.deserialize_struct("soma.rpc.EncoderCommitteeMember", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for EndOfEpochData {
        ...
        S: serde::Serializer,
    {
        ...
        if self.next_epoch_encoder_committee.is_some() {
            len += 1;
        }
        if self.next_epoch_networking_committee.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.next_epoch_encoder_committee.as_ref() {
            struct_ser.serialize_field("nextEpochEncoderCommittee", v)?;
        }
        if let Some(v) = self.next_epoch_networking_committee.as_ref() {
            struct_ser.serialize_field("nextEpochNetworkingCommittee", v)?;
        }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::NextEpochEncoderCommittee => {
                            if next_epoch_encoder_committee__.is_some() {
                                return Err(serde::de::Error::duplicate_field("nextEpochEncoderCommittee"));
                            }
                            next_epoch_encoder_committee__ = map_.next_value()?;
                        }
                        GeneratedField::NextEpochNetworkingCommittee => {
                            if next_epoch_networking_committee__.is_some() {
                                return Err(serde::de::Error::duplicate_field("nextEpochNetworkingCommittee"));
                            }
                            next_epoch_networking_committee__ = map_.next_value()?;
                        }
...
impl serde::Serialize for GetClaimableEscrowsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetClaimableEscrowsRequest", len)?;
        if let Some(v) = self.current_epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("currentEpoch", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.cursor.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("cursor", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for GetClaimableEscrowsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetClaimableEscrowsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetClaimableEscrowsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetClaimableEscrowsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("soma.rpc.GetClaimableEscrowsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetClaimableEscrowsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetClaimableEscrowsResponse", len)?;
        if !self.shards.is_empty() {
        ...
        if let Some(v) = self.next_cursor.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("nextCursor", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GetClaimableEscrowsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetClaimableEscrowsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetClaimableEscrowsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetClaimableEscrowsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("soma.rpc.GetClaimableEscrowsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetClaimableRewardsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetClaimableRewardsRequest", len)?;
        if let Some(v) = self.current_epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("currentEpoch", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetClaimableRewardsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetClaimableRewardsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetClaimableRewardsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetClaimableRewardsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut current_epoch__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetClaimableRewardsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetClaimableRewardsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetClaimableRewardsResponse", len)?;
        if !self.targets.is_empty() {
...
impl<'de> serde::Deserialize<'de> for GetClaimableRewardsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetClaimableRewardsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetClaimableRewardsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetClaimableRewardsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("soma.rpc.GetClaimableRewardsResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetShardsByEncoderRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetShardsByEncoderRequest", len)?;
        if let Some(v) = self.encoder.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("encoder", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.cursor.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for GetShardsByEncoderRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "encoder" => Ok(GeneratedField::Encoder),
                            "cursor" => Ok(GeneratedField::Cursor),
                            "limit" => Ok(GeneratedField::Limit),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetShardsByEncoderRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetShardsByEncoderRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetShardsByEncoderRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut encoder__ = None;
                let mut cursor__ = None;
                let mut limit__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::Encoder => {
                            if encoder__.is_some() {
                                return Err(serde::de::Error::duplicate_field("encoder"));
                            }
                            encoder__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::BytesDeserialize<_>>>()?.map(|x| x.0)
                            ;
        ...
        deserializer.deserialize_struct("soma.rpc.GetShardsByEncoderRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetShardsByEncoderResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetShardsByEncoderResponse", len)?;
        if !self.shards.is_empty() {
            struct_ser.serialize_field("shards", &self.shards)?;
        }
        if let Some(v) = self.next_cursor.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetShardsByEncoderResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetShardsByEncoderResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetShardsByEncoderResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetShardsByEncoderResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut shards__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetShardsByEncoderResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetShardsByEpochRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetShardsByEpochRequest", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetShardsByEpochRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetShardsByEpochRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetShardsByEpochRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetShardsByEpochRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetShardsByEpochRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetShardsByEpochResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetShardsByEpochResponse", len)?;
        if !self.shards.is_empty() {
            struct_ser.serialize_field("shards", &self.shards)?;
        }
        if let Some(v) = self.next_cursor.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetShardsByEpochResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetShardsByEpochResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetShardsByEpochResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetShardsByEpochResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut shards__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetShardsByEpochResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetShardsBySubmitterRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetShardsBySubmitterRequest", len)?;
        if let Some(v) = self.submitter.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("submitter", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
...
impl<'de> serde::Deserialize<'de> for GetShardsBySubmitterRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetShardsBySubmitterRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetShardsBySubmitterRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetShardsBySubmitterRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(GetShardsBySubmitterRequest {
        ...
        deserializer.deserialize_struct("soma.rpc.GetShardsBySubmitterRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetShardsBySubmitterResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetShardsBySubmitterResponse", len)?;
        if !self.shards.is_empty() {
            struct_ser.serialize_field("shards", &self.shards)?;
        }
        if let Some(v) = self.next_cursor.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetShardsBySubmitterResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetShardsBySubmitterResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetShardsBySubmitterResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetShardsBySubmitterResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut shards__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetShardsBySubmitterResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for GetValidTargetsRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetValidTargetsRequest", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for GetValidTargetsRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetValidTargetsRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetValidTargetsRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetValidTargetsRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetValidTargetsRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for GetValidTargetsResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.GetValidTargetsResponse", len)?;
        if !self.targets.is_empty() {
            struct_ser.serialize_field("targets", &self.targets)?;
        }
        if let Some(v) = self.next_cursor.as_ref() {
...
impl<'de> serde::Deserialize<'de> for GetValidTargetsResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = GetValidTargetsResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.GetValidTargetsResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<GetValidTargetsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut targets__ = None;
        ...
        deserializer.deserialize_struct("soma.rpc.GetValidTargetsResponse", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for InitiateShardWorkRequest {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        use serde::ser::SerializeStruct;
        let mut len = 0;
        if self.tx_digest.is_some() {
            len += 1;
        }
        if self.checkpoint_seq.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("soma.rpc.InitiateShardWorkRequest", len)?;
        if let Some(v) = self.tx_digest.as_ref() {
            struct_ser.serialize_field("txDigest", v)?;
        }
        if let Some(v) = self.checkpoint_seq.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("checkpointSeq", ToString::to_string(&v).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for InitiateShardWorkRequest {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::Deserialize<'de> for GeneratedField {
                ...
                D: serde::Deserializer<'de>,
            {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    {
                        match value {
                            "txDigest" | "tx_digest" => Ok(GeneratedField::TxDigest),
                            "checkpointSeq" | "checkpoint_seq" => Ok(GeneratedField::CheckpointSeq),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = InitiateShardWorkRequest;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.InitiateShardWorkRequest")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<InitiateShardWorkRequest, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut tx_digest__ = None;
                let mut checkpoint_seq__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        GeneratedField::TxDigest => {
                            if tx_digest__.is_some() {
                                return Err(serde::de::Error::duplicate_field("txDigest"));
                            }
                            tx_digest__ = map_.next_value()?;
                        }
                        GeneratedField::CheckpointSeq => {
                            if checkpoint_seq__.is_some() {
                                return Err(serde::de::Error::duplicate_field("checkpointSeq"));
                            }
                            checkpoint_seq__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                ...
                Ok(InitiateShardWorkRequest {
                    tx_digest: tx_digest__,
                    checkpoint_seq: checkpoint_seq__,
                })
            }
        }
        deserializer.deserialize_struct("soma.rpc.InitiateShardWorkRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for InitiateShardWorkResponse {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.InitiateShardWorkResponse", len)?;
...
impl<'de> serde::Deserialize<'de> for InitiateShardWorkResponse {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = InitiateShardWorkResponse;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.InitiateShardWorkResponse")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<InitiateShardWorkResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(InitiateShardWorkResponse {
                    shard: shard__,
                })
            }
        }
        deserializer.deserialize_struct("soma.rpc.InitiateShardWorkResponse", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for NetworkingCommittee {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.NetworkingCommittee", len)?;
        if let Some(v) = self.epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("epoch", ToString::to_string(&v).as_str())?;
...
impl<'de> serde::Deserialize<'de> for NetworkingCommittee {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = NetworkingCommittee;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.NetworkingCommittee")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<NetworkingCommittee, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut epoch__ = None;
                ...
                Ok(NetworkingCommittee {
                    epoch: epoch__,
                    members: members__.unwrap_or_default(),
                })
            }
        }
        deserializer.deserialize_struct("soma.rpc.NetworkingCommittee", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for NetworkingCommitteeMember {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.NetworkingCommitteeMember", len)?;
...
impl<'de> serde::Deserialize<'de> for NetworkingCommitteeMember {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = NetworkingCommitteeMember;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.NetworkingCommitteeMember")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<NetworkingCommitteeMember, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                ...
                Ok(NetworkingCommitteeMember {
                    authority_key: authority_key__,
                    network_metadata: network_metadata__,
                })
            }
        }
        deserializer.deserialize_struct("soma.rpc.NetworkingCommitteeMember", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ShardInfo {
        ...
        S: serde::Serializer,
    {
        ...
        if self.created_epoch.is_some() {
            len += 1;
        }
        if self.amount.is_some() {
            len += 1;
        }
        if self.data_submitter.is_some() {
            len += 1;
        }
        ...
        if self.winning_encoder.is_some() {
            len += 1;
        }
        let mut struct_ser = serializer.serialize_struct("soma.rpc.ShardInfo", len)?;
        if let Some(v) = self.shard_id.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("shardId", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.created_epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("createdEpoch", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.amount.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
        ...
        if let Some(v) = self.data_submitter.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("dataSubmitter", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.target.as_ref() {
            struct_ser.serialize_field("target", v)?;
        }
        if let Some(v) = self.has_winner.as_ref() {
            struct_ser.serialize_field("hasWinner", v)?;
        }
        if let Some(v) = self.winning_encoder.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("winningEncoder", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for ShardInfo {
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "createdEpoch" | "created_epoch" => Ok(GeneratedField::CreatedEpoch),
                            "amount" => Ok(GeneratedField::Amount),
                            "dataSubmitter" | "data_submitter" => Ok(GeneratedField::DataSubmitter),
                            "target" => Ok(GeneratedField::Target),
                            "hasWinner" | "has_winner" => Ok(GeneratedField::HasWinner),
                            "winningEncoder" | "winning_encoder" => Ok(GeneratedField::WinningEncoder),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.ShardInfo")
            }
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut created_epoch__ = None;
                let mut amount__ = None;
                let mut data_submitter__ = None;
                let mut target__ = None;
                let mut has_winner__ = None;
                let mut winning_encoder__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::CreatedEpoch => {
                            if created_epoch__.is_some() {
                                return Err(serde::de::Error::duplicate_field("createdEpoch"));
                            }
                            created_epoch__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        ...
                        GeneratedField::DataSubmitter => {
                            if data_submitter__.is_some() {
                                return Err(serde::de::Error::duplicate_field("dataSubmitter"));
                            }
                            data_submitter__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::BytesDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        ...
                        GeneratedField::HasWinner => {
                            if has_winner__.is_some() {
                                return Err(serde::de::Error::duplicate_field("hasWinner"));
                            }
                            has_winner__ = map_.next_value()?;
                        }
                        GeneratedField::WinningEncoder => {
                            if winning_encoder__.is_some() {
                                return Err(serde::de::Error::duplicate_field("winningEncoder"));
                            }
                            winning_encoder__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::BytesDeserialize<_>>>()?.map(|x| x.0)
                            ;
                ...
                Ok(ShardInfo {
                    shard_id: shard_id__,
                    created_epoch: created_epoch__,
                    amount: amount__,
                    data_submitter: data_submitter__,
                    target: target__,
                    has_winner: has_winner__,
                    winning_encoder: winning_encoder__,
                })
            }
        }
        deserializer.deserialize_struct("soma.rpc.ShardInfo", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for SystemParameters {
        ...
        S: serde::Serializer,
    {
        ...
        if self.target_selection_rate_bps.is_some() {
            len += 1;
        }
        if self.target_reward_allocation_bps.is_some() {
            len += 1;
        }
        if self.encoder_tally_slash_rate_bps.is_some() {
            len += 1;
        }
        ...
        if self.claim_incentive_bps.is_some() {
            len += 1;
        }
        ...
        if let Some(v) = self.target_selection_rate_bps.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("targetSelectionRateBps", ToString::to_string(&v).as_str())?;
        }
        ...
        if let Some(v) = self.encoder_tally_slash_rate_bps.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("encoderTallySlashRateBps", ToString::to_string(&v).as_str())?;
        }
        ...
        if let Some(v) = self.claim_incentive_bps.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("claimIncentiveBps", ToString::to_string(&v).as_str())?;
        }
        struct_ser.end()
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "targetSelectionRateBps" | "target_selection_rate_bps" => Ok(GeneratedField::TargetSelectionRateBps),
                            "targetRewardAllocationBps" | "target_reward_allocation_bps" => Ok(GeneratedField::TargetRewardAllocationBps),
                            "encoderTallySlashRateBps" | "encoder_tally_slash_rate_bps" => Ok(GeneratedField::EncoderTallySlashRateBps),
                            ...
                            "claimIncentiveBps" | "claim_incentive_bps" => Ok(GeneratedField::ClaimIncentiveBps),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                    ...
                    V: serde::de::MapAccess<'de>,
            {
                ...
                let mut target_selection_rate_bps__ = None;
                let mut target_reward_allocation_bps__ = None;
                let mut encoder_tally_slash_rate_bps__ = None;
                ...
                let mut claim_incentive_bps__ = None;
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::TargetSelectionRateBps => {
                            if target_selection_rate_bps__.is_some() {
                                return Err(serde::de::Error::duplicate_field("targetSelectionRateBps"));
                            }
                            target_selection_rate_bps__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        }
                        ...
                        GeneratedField::EncoderTallySlashRateBps => {
                            if encoder_tally_slash_rate_bps__.is_some() {
                                return Err(serde::de::Error::duplicate_field("encoderTallySlashRateBps"));
                            }
                            encoder_tally_slash_rate_bps__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        }
                        ...
                        GeneratedField::ClaimIncentiveBps => {
                            if claim_incentive_bps__.is_some() {
                                return Err(serde::de::Error::duplicate_field("claimIncentiveBps"));
                            }
                            claim_incentive_bps__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        }
                        GeneratedField::__SkipField__ => {
                ...
                Ok(SystemParameters {
                    ...
                    target_selection_rate_bps: target_selection_rate_bps__,
                    target_reward_allocation_bps: target_reward_allocation_bps__,
                    encoder_tally_slash_rate_bps: encoder_tally_slash_rate_bps__,
                    ...
                    claim_incentive_bps: claim_incentive_bps__,
                })
            }
        }
...
impl serde::Serialize for TargetInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("soma.rpc.TargetInfo", len)?;
        if let Some(v) = self.target_id.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("targetId", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.created_epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
        ...
        if let Some(v) = self.valid_epoch.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("validEpoch", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.origin.as_ref() {
            let v = TargetOriginType::try_from(*v)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", *v)))?;
        ...
        if let Some(v) = self.creator.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("creator", crate::utils::_serde::base64::encode(&v).as_str())?;
        }
        if let Some(v) = self.reward_amount.as_ref() {
            #[allow(clippy::needless_borrow)]
            #[allow(clippy::needless_borrows_for_generic_args)]
            struct_ser.serialize_field("rewardAmount", ToString::to_string(&v).as_str())?;
        }
        if let Some(v) = self.has_winner.as_ref() {
            struct_ser.serialize_field("hasWinner", v)?;
        }
...
impl<'de> serde::Deserialize<'de> for TargetInfo {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "createdEpoch" | "created_epoch" => Ok(GeneratedField::CreatedEpoch),
                            "validEpoch" | "valid_epoch" => Ok(GeneratedField::ValidEpoch),
        ...
        #[allow(clippy::unit_arg)]
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = TargetInfo;

            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct soma.rpc.TargetInfo")
            }

            fn visit_map<V>(self, mut map_: V) -> std::result::Result<TargetInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut target_id__ = None;
                let mut created_epoch__ = None;
                let mut valid_epoch__ = None;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::ValidEpoch => {
                            if valid_epoch__.is_some() {
                                return Err(serde::de::Error::duplicate_field("validEpoch"));
                            }
                            valid_epoch__ = 
                                map_.next_value::<::std::option::Option<crate::utils::_serde::NumberDeserialize<_>>>()?.map(|x| x.0)
                            ;
                        ...
                        GeneratedField::Origin => {
                            ...
                            origin__ = map_.next_value::<::std::option::Option<TargetOriginType>>()?.map(|x| x as i32);
                        }
        ...
        deserializer.deserialize_struct("soma.rpc.TargetInfo", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for TargetOriginType {
    #[allow(deprecated)]
    fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for TargetOriginType {
    #[allow(deprecated)]
    fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        const FIELDS: &[&str] = &[
            "TARGET_ORIGIN_UNSPECIFIED",
            "TARGET_ORIGIN_SYSTEM",
            "TARGET_ORIGIN_USER",
            "TARGET_ORIGIN_GENESIS",
        ];

        struct GeneratedVisitor;

        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            type Value = TargetOriginType;
            ...
            {
                match value {
                    "TARGET_ORIGIN_UNSPECIFIED" => Ok(TargetOriginType::TargetOriginUnspecified),
                    "TARGET_ORIGIN_SYSTEM" => Ok(TargetOriginType::TargetOriginSystem),
                    "TARGET_ORIGIN_USER" => Ok(TargetOriginType::TargetOriginUser),
                    "TARGET_ORIGIN_GENESIS" => Ok(TargetOriginType::TargetOriginGenesis),
                    _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
                }
            }
        }
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.kind.as_ref() {
            match v {
                ...
                transaction_kind::Kind::ClaimReward(v) => {
                    struct_ser.serialize_field("claimReward", v)?;
                }
            }
        }
        struct_ser.end()
                ...
                impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                        ...
                        E: serde::de::Error,
                    {
                        match value {
                            ...
                            "claimReward" | "claim_reward" => Ok(GeneratedField::ClaimReward),
                            _ => Ok(GeneratedField::__SkipField__),
                        }
                    }
                }
...
;
                        ...
                        GeneratedField::ClaimReward => {
                            if kind__.is_some() {
                                return Err(serde::de::Error::duplicate_field("claimReward"));
                            }
                            kind__ = map_.next_value::<::std::option::Option<_>>()?.map(transaction_kind::Kind::ClaimReward)
;
                        }
                        GeneratedField::__SkipField__ => {
                            let _ = map_.next_value::<serde::de::IgnoredAny>()?;
