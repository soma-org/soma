...
fn write_serialize_scalar_variable<W: Write>(
    ...
    let conversion = match scalar {
        ...
        ScalarType::Bytes => "crate::utils::_serde::base64::encode",
        _ => {
            return writeln!(
                writer,
                "{}struct_ser.serialize_field(\"{}\", {})?;",
            ...
            FieldType::Map(key, value) => {
                ...
                let map_k = match key {
                    ...
                    _ if key.is_numeric() => {
                        write!(
                            writer,
                            "crate::utils::_serde::NumberDeserialize<{}>",
                            key.rust_type()
                        )?;
                        "k.0"
                    }
                ...
                let map_v = match value.as_ref() {
                    ...
                    FieldType::Scalar(ScalarType::Bytes) => {
                        write!(writer, "crate::utils::_serde::BytesDeserialize<_>",)?;
                        "v.0"
                    }
                    FieldType::Enum(path) => {
...
fn override_deserializer(scalar: ScalarType) -> Option<&'static str> {
    match scalar {
        ScalarType::Bytes => Some("crate::utils::_serde::BytesDeserialize<_>"),
        _ if scalar.is_numeric() => Some("crate::utils::_serde::NumberDeserialize<_>"),
        _ => None,
    }
}
...
fn well_known_type_deserializer(type_path: &TypePath) -> Option<&'static str> {
    ...
    match type_name.as_str() {
        "google.protobuf.FieldMask" => Some("crate::utils::_serde::FieldMaskDeserializer"),
        "google.protobuf.Timestamp" => Some("crate::utils::_serde::TimestampDeserializer"),
        "google.protobuf.Duration" => Some("crate::utils::_serde::DurationDeserializer"),
        "google.protobuf.Value" => Some("crate::utils::_serde::ValueDeserializer"),
        "google.protobuf.Any" => Some("crate::utils::_serde::AnyDeserializer"),
        "google.protobuf.Empty" => Some("crate::utils::_serde::EmptyDeserializer"),
        _ => None,
    }
}
...
fn well_known_type_serializer(type_path: &TypePath) -> Option<&'static str> {
    ...
    match type_name.as_str() {
        "google.protobuf.FieldMask" => Some("crate::utils::_serde::FieldMaskSerializer"),
        "google.protobuf.Timestamp" => Some("crate::utils::_serde::TimestampSerializer"),
        "google.protobuf.Duration" => Some("crate::utils::_serde::DurationSerializer"),
        "google.protobuf.Value" => Some("crate::utils::_serde::ValueSerializer"),
        "google.protobuf.Any" => Some("crate::utils::_serde::AnySerializer"),
        "google.protobuf.Empty" => Some("crate::utils::_serde::EmptySerializer"),
        _ => None,
    }
}
