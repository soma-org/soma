...
use types::storage::consensus::WriteBatch;
...
impl DagState {
    pub(crate) fn new(context: Arc<Context>, store: Arc<dyn ConsensusStore>) -> Self {
    ...
    // TODO: use add_commit_info for reputation scores
...
mod test {
    ...
    use types::storage::consensus::{mem_store::MemStore, WriteBatch};
